    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-center">
            <div className="border-2 border-black p-4 flex flex-col gap-5 text-xl font-bold">
                ...
                <button className="bg-black text-white rounded-2xl p-1.5 hover:cursor-pointer">Create Apprentice</button>
                <button className="bg-black text-white rounded-2xl p-1.5 hover:cursor-pointer">Recruit Soldier'</button>
